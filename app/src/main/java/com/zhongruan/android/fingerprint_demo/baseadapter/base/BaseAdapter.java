...
import com.zhongruan.android.fingerprint_demo.baseadapter.Util;
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected boolean isCommonItemView(int viewType) {
        return viewType != TYPE_EMPTY_VIEW && viewType != TYPE_FOOTER_VIEW && viewType != TYPE_NODATA_VIEW && viewType != TYPE_RELOAD_VIEW && !(viewType >= TYPE_BASE_HEADER_VIEW);
    }
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (findLastVisibleItemPosition(layoutManager) + 1 == getItemCount()) {
                    if (mEmptyView != null || mReloadView != null || (mHeaderViews.size() > 0 && showHeaderView && mDatas.isEmpty())) {
                        return;
                    }
