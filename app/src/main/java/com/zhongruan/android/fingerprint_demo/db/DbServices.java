...
public class DbServices {
    ...
    public List<Bk_ks> queryBKKSList(List<Ks_kc> ks_kcmc, String ks_ccmc) {
        ...
        for (int i = 0; i < ks_kcmc.size(); i++) {
            bkKsList.addAll(bk_ksDao.queryBuilder().where(Bk_ksDao.Properties.Ks_ccmc.eq(ks_ccmc)).where(Bk_ksDao.Properties.Ks_kcmc.eq(ks_kcmc.get(i).getKc_name())).orderAsc(Bk_ksDao.Properties.Ks_zwh).list());
        }
        return bkKsList;
    }
    ...
    public int queryBkKsIsTG(List<Ks_kc> ks_kcmc, String ks_ccmc, String isRZ) {
        List<Bk_ks> list = new ArrayList<>();
        for (int i = 0; i < ks_kcmc.size(); i++) {
            list.addAll(bk_ksDao.queryBuilder().where(Bk_ksDao.Properties.Ks_kcmc.eq(ks_kcmc.get(i).getKc_name())).where(Bk_ksDao.Properties.Ks_ccmc.eq(ks_ccmc)).where(Bk_ksDao.Properties.IsRZ.eq(isRZ)).distinct().list());
        }
        return list.size();
    }
    ...
    public int queryBkKsWTG(List<Ks_kc> ks_kcmc, String ks_ccmc, String isRZ) {
        List<Bk_ks> list = new ArrayList<>();
        for (int i = 0; i < ks_kcmc.size(); i++) {
            list.addAll(bk_ksDao.queryBuilder().where(Bk_ksDao.Properties.Ks_kcmc.eq(ks_kcmc.get(i).getKc_name())).where(Bk_ksDao.Properties.Ks_ccmc.eq(ks_ccmc)).where(Bk_ksDao.Properties.IsRZ.notEq(isRZ)).distinct().list());
        }
        return list.size();
    }
    ...
    public Bk_ks selectBKKSs(String kcmc, String ccno, String zjno) {
    ...
    public Bk_ks selectBKKSs(List<Ks_kc> kcmc, String ccno, String zjno) {
        Bk_ks bk_ks = new Bk_ks();
        for (int i = 0; i < kcmc.size(); i++) {
            bk_ks = bk_ksDao.queryBuilder().where(Bk_ksDao.Properties.Ks_kcmc.eq(kcmc.get(i).getKc_name())).where(Bk_ksDao.Properties.Ks_ccno.eq(ccno)).whereOr(Bk_ksDao.Properties.Ks_zjno.eq(zjno.toLowerCase()), Bk_ksDao.Properties.Ks_zjno.eq(zjno.toUpperCase())).build().unique();
            if (bk_ks != null) {
                return bk_ks;
            }
        }
    ...
    public long saveRzjl(Sfrz_rzjl sfrzRzjl) {
        return rzjlDao.insert(sfrzRzjl);
    }

    public long saveRzjg(Sfrz_rzjg sfrzRzjg) {
        return rzjgDao.insert(sfrzRzjg);
    }
    ...
    public void saveBkKs3(String ks_kcmc, String ks_ccno, String zjno) {
        List<Bk_ks> bk_ks = bk_ksDao.queryBuilder().where(Bk_ksDao.Properties.Ks_kcmc.eq(ks_kcmc)).where(Bk_ksDao.Properties.Ks_ccno.eq(ks_ccno)).where(Bk_ksDao.Properties.Ks_zjno.eq(zjno)).list();
        LogUtil.i(zjno);
        LogUtil.i(bk_ks);
        LogUtil.i(bk_ks.size());
    ...
    public void saveBkKs2(String ks_kcmc, String ks_ccno, String zjno) {
        List<Bk_ks> bk_ks = bk_ksDao.queryBuilder().where(Bk_ksDao.Properties.Ks_kcmc.eq(ks_kcmc)).where(Bk_ksDao.Properties.Ks_ccno.eq(ks_ccno)).where(Bk_ksDao.Properties.Ks_zjno.eq(zjno)).list();
        LogUtil.i(zjno);
        LogUtil.i(bk_ks);
        LogUtil.i(bk_ks.size());
