...
public class Sb_settingDao extends AbstractDao<Sb_setting, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Sb_ms = new Property(2, String.class, "sb_ms", false, "sb_ms");
        public final static Property Sb_hyfs = new Property(3, String.class, "sb_hyfs", false, "sb_hyfs");
        public final static Property Sb_finger_fz = new Property(4, String.class, "sb_finger_fz", false, "sb_finger_fz");
        public final static Property Sb_finger_cfcs = new Property(5, String.class, "sb_finger_cfcs", false, "sb_finger_cfcs");
        public final static Property Sb_face_xsd = new Property(6, String.class, "sb_face_xsd", false, "sb_face_xsd");
        public final static Property Sb_finger_bdfw = new Property(7, String.class, "sb_finger_bdfw", false, "sb_finger_bdfw");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"sb_setting\" (" + //
                ...
                "\"sb_ip\" TEXT," + // 1: sb_ip
                "\"sb_ms\" TEXT," + // 2: sb_ms
                "\"sb_hyfs\" TEXT," + // 3: sb_hyfs
                "\"sb_finger_fz\" TEXT," + // 4: sb_finger_fz
                "\"sb_finger_cfcs\" TEXT," + // 5: sb_finger_cfcs
                "\"sb_face_xsd\" TEXT," + // 6: sb_face_xsd
                "\"sb_finger_bdfw\" TEXT," + // 7: sb_finger_bdfw
    ...
    protected final void bindValues(DatabaseStatement stmt, Sb_setting entity) {
        ...
        if (sb_ms != null) {
            stmt.bindString(3, sb_ms);
        }
 
        String sb_hyfs = entity.getSb_hyfs();
        if (sb_hyfs != null) {
            stmt.bindString(4, sb_hyfs);
        }
 
        String sb_finger_fz = entity.getSb_finger_fz();
        if (sb_finger_fz != null) {
            stmt.bindString(5, sb_finger_fz);
        }
 
        String sb_finger_cfcs = entity.getSb_finger_cfcs();
        if (sb_finger_cfcs != null) {
            stmt.bindString(6, sb_finger_cfcs);
        }
 
        String sb_face_xsd = entity.getSb_face_xsd();
        if (sb_face_xsd != null) {
            stmt.bindString(7, sb_face_xsd);
        }
 
        String sb_finger_bdfw = entity.getSb_finger_bdfw();
        if (sb_finger_bdfw != null) {
            stmt.bindString(8, sb_finger_bdfw);
        }
    ...
    public Sb_setting readEntity(Cursor cursor, int offset) {
        Sb_setting entity = new Sb_setting( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // sb_ms
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // sb_hyfs
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // sb_finger_fz
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // sb_finger_cfcs
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // sb_face_xsd
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // sb_finger_bdfw
    ...
    public void readEntity(Cursor cursor, Sb_setting entity, int offset) {
        ...
        entity.setSb_ms(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setSb_hyfs(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setSb_finger_fz(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setSb_finger_cfcs(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setSb_face_xsd(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setSb_finger_bdfw(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
