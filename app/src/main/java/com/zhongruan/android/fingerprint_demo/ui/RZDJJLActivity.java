...
import com.zhongruan.android.fingerprint_demo.view.UploadProgressBar;
...
public class RZDJJLActivity extends BaseActivity implements View.OnClickListener, ExpandableListView.OnChildClickListener, View.OnTouchListener {
    ...
    public void initData() {
        ...
        mListItemPiechart.setData(setPiechartData(DbServices.getInstance(getBaseContext()).queryBkKsYyz(kcmc, ccmc), DbServices.getInstance(getBaseContext()).queryBkKsIsTG(kcmc, ccmc, "2"), bk_ks.size()));
    ...
    private PieData setPiechartData(int paramInt1, int paramInt2, int paramInt3) {
        ...
        if (paramInt3 != 0) {
            ...
            pieEntries.add(new PieEntry(arrayOfFloat[0], "缺考"));
            pieEntries.add(new PieEntry(arrayOfFloat[1], "已验证"));
